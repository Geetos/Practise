...
import com.jxtele.projectmanage.service.IRoleService;
import com.jxtele.projectmanage.util.ParameterMap;
import com.jxtele.projectmanage.util.RightsHelper;
...
public class RoleService implements IRoleService {
	...
	public Map<String, Object> editusercontrol(ParameterMap pm) {
		try {
			UserControl userControl = userControlMapper.selectByPrimaryKey(Integer.parseInt(pm.getString("usercontrol_id")));
			pm.put("usercomtrol_name",userControl.getControlName());
			roleDao.updateRoleQX(pm);
		} catch (Exception e) {
			log.error("error", e);
			return ResponseModel.getModel("error", "failed", null);
