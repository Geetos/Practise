...
public class Role {
	...
	private String usercomtrolName;
	...
	public String getUsercomtrolName() {
		return usercomtrolName;
	}

	public void setUsercomtrolName(String usercomtrolName) {
		this.usercomtrolName = usercomtrolName;
	}
	...
	public Role(long roleId, String roleName, String roleDesc, String rights, String addQX, String delQX,
			String editQX, String queryQX,Integer usercontrolId,String usercomtrolName) {
		super();
		this.roleId = roleId;
		this.roleName = roleName;
		this.roleDesc = roleDesc;
	...
	public String toString() {
		return "Role{" +
				...
				", usercomtrolName='" + usercomtrolName + '\'' +
				'}';
	}
